...
namespace GradeBook.GradeBooks
{
    public abstract class BaseGradeBook
    {
        ...
        {
            var increment = GPAIncrement(studentType);
            int baseGPA;
        ...
        private int GPAIncrement(StudentType studentType)
        {
            if (IsWeighted && (studentType == StudentType.Honors || studentType == StudentType.DualEnrolled)) return 1;
            return 0;
        }
    }
}
